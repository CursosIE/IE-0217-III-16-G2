...
\index{Graph\-With\-Pointer@{Graph\-With\-Pointer}!graph@{graph}}
\index{graph@{graph}!GraphWithPointer@{Graph\-With\-Pointer}}
\subsubsection[{graph}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D $>$ {\bf Node}$<$D$>$$\ast$$\ast$ {\bf Graph\-With\-Pointer}$<$ D $>$\-::graph}\label{class_graph_with_pointer_aa0244d4abba9a569013bfeea80d8bdc8}


Arreglo de tipo \doxyref{Node}{p.}{class_node} Pointer, donde se guardan los nodos que contiene el grafo. 

\index{Graph\-With\-Pointer@{Graph\-With\-Pointer}!max\-Elements@{max\-Elements}}
\index{max\-Elements@{max\-Elements}!GraphWithPointer@{Graph\-With\-Pointer}}
\subsubsection[{max\-Elements}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D $>$ int {\bf Graph\-With\-Pointer}$<$ D $>$\-::max\-Elements}\label{class_graph_with_pointer_a43179fee097cf66b2b6c28a8686c0b45}


Atributo que indica la maxima cantidad de elementos que permite graph. 

\index{Graph\-With\-Pointer@{Graph\-With\-Pointer}!num\-Nodes@{num\-Nodes}}
\index{num\-Nodes@{num\-Nodes}!GraphWithPointer@{Graph\-With\-Pointer}}
\subsubsection[{num\-Nodes}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D $>$ int {\bf Graph\-With\-Pointer}$<$ D $>$\-::num\-Nodes}\label{class_graph_with_pointer_a6385986823450390617bd282e1833d97}
...
\item 
{\bf Graph\-With\-Pointer.\-h}\end{DoxyCompactItemize}
