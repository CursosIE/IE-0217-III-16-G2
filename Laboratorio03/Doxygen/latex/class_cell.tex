...
\subsubsection[{Cell}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D$>$ {\bf Cell}$<$ D $>$\-::{\bf Cell} (
\begin{DoxyParamCaption}
\item[{const {\bf Cell}$<$ D $>$ \&}]{orig}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\label{class_cell_a260a5d52d571c8d2f951d81df17154e2}
\index{Cell@{Cell}!$\sim$\-Cell@{$\sim$\-Cell}}
\index{$\sim$\-Cell@{$\sim$\-Cell}!Cell@{Cell}}
\subsubsection[{$\sim$\-Cell}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D$>$ virtual {\bf Cell}$<$ D $>$\-::$\sim${\bf Cell} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}\label{class_cell_a8a6091a249d6ff583049c35c85f4d778}


\subsection{Member Data Documentation}
\index{Cell@{Cell}!data@{data}}
\index{data@{data}!Cell@{Cell}}
\subsubsection[{data}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D$>$ D$\ast$ {\bf Cell}$<$ D $>$\-::data}\label{class_cell_ab8cc4d3059ef84a652eabc05b6c28f49}
...
\subsubsection[{next}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D$>$ {\bf Cell}$\ast$ {\bf Cell}$<$ D $>$\-::next}\label{class_cell_a7e0e6c090f8aca70862c2dbc3257e3b9}
...
\item 
{\bf Cell.\-h}\end{DoxyCompactItemize}
