...
public:
  ...
  * \param data es un puntero a un objeto tipo D.
  * \param maxElements es la maxima cantidad de elementos de la lista. 
  * \param n es la cantidad de elementos en la lista. 
  */  
...
ListWithArray() {
  ...
  * \param t es la cantidad de elementos. Este se recibe como parametro 
  * del constructor. 
  * \param maxElements esla maxima cantidad de elementos de la lista. 
  * \param n es la cantidad de elementos en la lista. 
  */  
